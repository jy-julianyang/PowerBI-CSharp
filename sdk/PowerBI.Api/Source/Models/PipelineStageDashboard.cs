...
{
    /// <summary> The metadata for a deployment pipeline dashboard. </summary>
    public partial class PipelineStageDashboard : PipelineStageArtifactBase
    {
        /// <summary> Initializes a new instance of <see cref="PipelineStageDashboard"/>. </summary>
        /// <param name="artifactId"> The Power BI item ID. </param>
        internal PipelineStageDashboard(Guid artifactId) : base(artifactId)
        {
        }
        ...
        internal PipelineStageDashboard(Guid artifactId, string artifactDisplayName, Guid? sourceArtifactId, Guid? targetArtifactId, DateTimeOffset? lastDeploymentTime) : base(artifactId, artifactDisplayName, sourceArtifactId, targetArtifactId, lastDeploymentTime)
        {
        }
    }
}
