...
{
    public partial class PipelineStageDataset
    {
        internal static PipelineStageDataset DeserializePipelineStageDataset(JsonElement element)
        {
        ...
        internal static new PipelineStageDataset FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializePipelineStageDataset(document.RootElement);
        }
    }
}
