...
{
    public partial class ReportUser : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            writer.WritePropertyName("reportUserAccessRight"u8);
            writer.WriteStringValue(ReportUserAccessRight.ToSerialString());
        ...
        internal static ReportUser DeserializeReportUser(JsonElement element)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            ReportUserAccessRight reportUserAccessRight = default;
            ...
            {
                if (property.NameEquals("reportUserAccessRight"u8))
                {
                    reportUserAccessRight = property.Value.GetString().ToReportUserAccessRight();
                    continue;
                }
        ...
        internal static new ReportUser FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeReportUser(document.RootElement);
        }
