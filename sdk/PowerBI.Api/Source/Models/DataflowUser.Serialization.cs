...
{
    public partial class DataflowUser : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Optional.IsDefined(DataflowUserAccessRight))
            {
                writer.WritePropertyName("DataflowUserAccessRight"u8);
                writer.WriteStringValue(DataflowUserAccessRight.Value.ToSerialString());
            }
        ...
        internal static DataflowUser DeserializeDataflowUser(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("DataflowUserAccessRight"u8))
                {
                    ...
                    dataflowUserAccessRight = property.Value.GetString().ToDataflowUserAccessRight();
                    continue;
                }
