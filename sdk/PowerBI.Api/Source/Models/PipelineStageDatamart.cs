...
{
    /// <summary> The metadata for a deployment pipeline datamart. </summary>
    public partial class PipelineStageDatamart : PipelineStageArtifactBase
    {
        /// <summary> Initializes a new instance of <see cref="PipelineStageDatamart"/>. </summary>
        /// <param name="artifactId"> The Power BI item ID. </param>
        internal PipelineStageDatamart(Guid artifactId) : base(artifactId)
        {
        }
        ...
        internal PipelineStageDatamart(Guid artifactId, string artifactDisplayName, Guid? sourceArtifactId, Guid? targetArtifactId, DateTimeOffset? lastDeploymentTime) : base(artifactId, artifactDisplayName, sourceArtifactId, targetArtifactId, lastDeploymentTime)
        {
        }
    }
}
