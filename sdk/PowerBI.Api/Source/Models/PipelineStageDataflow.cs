...
{
    /// <summary> The metadata for a deployment pipeline dataflow. </summary>
    public partial class PipelineStageDataflow : PipelineStageArtifactBase
    {
        /// <summary> Initializes a new instance of <see cref="PipelineStageDataflow"/>. </summary>
        /// <param name="artifactId"> The Power BI item ID. </param>
        internal PipelineStageDataflow(Guid artifactId) : base(artifactId)
        {
        }
        ...
        internal PipelineStageDataflow(Guid artifactId, string artifactDisplayName, Guid? sourceArtifactId, Guid? targetArtifactId, DateTimeOffset? lastDeploymentTime) : base(artifactId, artifactDisplayName, sourceArtifactId, targetArtifactId, lastDeploymentTime)
        {
        }
    }
}
