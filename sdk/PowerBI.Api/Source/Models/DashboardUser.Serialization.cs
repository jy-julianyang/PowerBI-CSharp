...
{
    public partial class DashboardUser : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            writer.WritePropertyName("dashboardUserAccessRight"u8);
            writer.WriteStringValue(DashboardUserAccessRight.ToSerialString());
        ...
        internal static DashboardUser DeserializeDashboardUser(JsonElement element)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            DashboardUserAccessRight dashboardUserAccessRight = default;
            ...
            {
                if (property.NameEquals("dashboardUserAccessRight"u8))
                {
                    dashboardUserAccessRight = property.Value.GetString().ToDashboardUserAccessRight();
                    continue;
                }
        ...
        internal static new DashboardUser FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeDashboardUser(document.RootElement);
        }
