...
{
    public partial class CapacityUser : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            writer.WritePropertyName("capacityUserAccessRight"u8);
            writer.WriteStringValue(CapacityUserAccessRight.ToSerialString());
        ...
        internal static CapacityUser DeserializeCapacityUser(JsonElement element)
        {
        ...
        internal static new CapacityUser FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeCapacityUser(document.RootElement);
        }
