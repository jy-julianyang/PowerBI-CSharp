...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ReportUser"/>. </summary>
        /// <param name="identifier"> Identifier of the principal. </param>
        /// <param name="principalType"> The principal type. </param>
        /// <param name="reportUserAccessRight"> The access right that the user has for the report (permission level). </param>
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> is null. </exception>
        public ReportUser(string identifier, PrincipalType principalType, ReportUserAccessRight reportUserAccessRight) : base(identifier, principalType)
        {
        ...
        /// <param name="reportUserAccessRight"> The access right that the user has for the report (permission level). </param>
        internal ReportUser(string emailAddress, string displayName, string identifier, string graphId, string userType, PrincipalType principalType, ServicePrincipalProfile profile, ReportUserAccessRight reportUserAccessRight) : base(emailAddress, displayName, identifier, graphId, userType, principalType, profile)
        {
            ReportUserAccessRight = reportUserAccessRight;
        }
