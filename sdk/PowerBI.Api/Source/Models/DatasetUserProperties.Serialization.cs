...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class DatasetUserProperties : IUtf8JsonSerializable
    {
        ...
        internal static DatasetUserProperties DeserializeDatasetUserProperties(JsonElement element)
        {
            ...
            return new DatasetUserProperties(users ?? new ChangeTrackingList<DatasetUser>());
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static DatasetUserProperties FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeDatasetUserProperties(document.RootElement);
        }
