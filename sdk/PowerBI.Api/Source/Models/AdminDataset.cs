...
{
    /// <summary> A Power BI dataset returned by Admin APIs. The API returns a subset of the following list of dataset properties. The subset depends on the API called, caller permissions, and the availability of the data in the Power BI database. </summary>
    public partial class AdminDataset : DatasetBaseProperties
    {
        /// <summary> Initializes a new instance of <see cref="AdminDataset"/>. </summary>
        /// <param name="id"> The dataset ID. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> is null. </exception>
        public AdminDataset(string id) : base(id)
        {
