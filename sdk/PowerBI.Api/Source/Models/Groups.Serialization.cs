...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class Groups
    {
        internal static Groups DeserializeGroups(JsonElement element)
        {
            ...
            IReadOnlyList<Group> value = default;
            ...
            return new Groups(odataContext, value ?? new ChangeTrackingList<Group>());
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static Groups FromResponse(Response response)
        {
