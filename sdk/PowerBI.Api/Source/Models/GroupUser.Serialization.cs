...
{
    public partial class GroupUser : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            writer.WritePropertyName("groupUserAccessRight"u8);
            writer.WriteStringValue(GroupUserAccessRight.ToSerialString());
        ...
        internal static GroupUser DeserializeGroupUser(JsonElement element)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            GroupUserAccessRight groupUserAccessRight = default;
            ...
            {
                if (property.NameEquals("groupUserAccessRight"u8))
                {
                    groupUserAccessRight = property.Value.GetString().ToGroupUserAccessRight();
                    continue;
                }
        ...
        internal static new GroupUser FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeGroupUser(document.RootElement);
        }
