...
{
    /// <summary> The metadata for a deployment pipeline report. </summary>
    public partial class PipelineStageReport : PipelineStageArtifactBase
    {
        /// <summary> Initializes a new instance of <see cref="PipelineStageReport"/>. </summary>
        /// <param name="artifactId"> The Power BI item ID. </param>
        internal PipelineStageReport(Guid artifactId) : base(artifactId)
        {
        }
        ...
        internal PipelineStageReport(Guid artifactId, string artifactDisplayName, Guid? sourceArtifactId, Guid? targetArtifactId, DateTimeOffset? lastDeploymentTime) : base(artifactId, artifactDisplayName, sourceArtifactId, targetArtifactId, lastDeploymentTime)
        {
        }
    }
}
