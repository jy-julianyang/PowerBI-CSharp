...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class Datasources
    {
        internal static Datasources DeserializeDatasources(JsonElement element)
        {
            ...
            return new Datasources(odataContext, value ?? new ChangeTrackingList<Datasource>());
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static Datasources FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeDatasources(document.RootElement);
        }
    }
}
