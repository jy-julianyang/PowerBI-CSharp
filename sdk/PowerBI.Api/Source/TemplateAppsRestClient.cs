...
{
    internal partial class TemplateAppsRestClient
    {
        ...
        /// <summary> Initializes a new instance of TemplateAppsRestClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="clientDiagnostics"/> or <paramref name="pipeline"/> is null. </exception>
        public TemplateAppsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null)
        {
        ...
        internal HttpMessage CreateCreateInstallTicketRequest(CreateInstallTicketRequest requestParameters)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/v1.0/myorg/CreateTemplateAppInstallTicket", false);
            request.Uri = uri;
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public async Task<Response<InstallTicket>> CreateInstallTicketAsync(CreateInstallTicketRequest requestParameters, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateCreateInstallTicketRequest(requestParameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        InstallTicket value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = InstallTicket.DeserializeInstallTicket(document.RootElement);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public Response<InstallTicket> CreateInstallTicket(CreateInstallTicketRequest requestParameters, CancellationToken cancellationToken = default)
        {
            if (requestParameters == null)
            {
                throw new ArgumentNullException(nameof(requestParameters));
